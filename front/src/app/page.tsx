...
export default function Home() {
    ...
    datasets: [
      {
        ...
        backgroundColor: [
          "#2ecc71", "#e74c3c", "#f1c40f", "#3498db", "#2ecc71", "#e67e22", "#f1c40f"
        ],
      },
    ],
  };
  ...
  data-aos="fade-right"
>
  <Typer text="GeneScope is an AI-powered dashboard that leverages deep learning models to provide prognosis and analytical insights based on patients' gene expression data. 
...
>
  <p className="text-lg">
    In 2015, an estimated 231,840 new invasive breast cancer cases were reported
     in the U.S., with the highest incidence in individuals aged 50-69.
      While cases in younger individuals  were lower,
       early detection remains critical for improving outcomes. Most cases
        occur in older adults, reinforcing the need for routine screening
        and timely intervention to reduce mortality.
  </p>
</motion.div>
...
>
  <p className="text-lg">
  Early detection saves lives. In the U.S., 66% of breast cancer cases are diagnosed at a localized stage, where survival rates exceed 90% with timely treatment. However, nearly 26% of cases spread to lymph nodes, and 5.8% reach distant organs, making treatment more difficult.
  </p>
</motion.div>
